...
//     } else if (/\/$/.test(window.location.pathname)) {
//         activeNavId = "navHome";
//     } else if (/sched\.html$/.test(window.location.pathname)) {
//         activeNavId = "navSched";
//     } else if (/r[a-z]+\.html$/.test(window.location.pathname)) {
//         activeNavId = "navRef";
//     } else if (/a[a-z]+\.html$/.test(window.location.pathname)) {
//         activeNavId = "navApps";
//     } else if (/h[a-z]+\.html$/.test(window.location.pathname)) {
//         activeNavId = "navHW";
//     } else if (/i[a-z]+\.html$/.test(window.location.pathname)) {
//         activeNavId = "navInfo";
//     } else if (/p[a-z]+\.html$/.test(window.location.pathname)) {
